...
class Taxi( Transportation ):
   ...
   def __init__( self, start, end, distance ):
      Transportation.__init__( self, start, end, distance)
      self.price_per_distance = 40

   def find_cost( self ):
      return self.price_per_distance * self.distance
...
class Train( Transportation ):
    ...
    def __init__( self, start, end, distance, stations ):
      Transportation.__init__( self, start, end, distance)
      self.price_per_station = 5
      self.num_of_station = stations
   
    def find_cost( self ):
      return self.price_per_station * self.num_of_station
